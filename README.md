...
```shell
git clone git@github.com:pubkeyapp/pubkey-program-sandbox.git
cd pubkey-program-sandbox
pnpm
```
...
```shell
> NX Generating @pubkey-program-sandbox/tools:prisma-model
...
```shell
> NX Generating @pubkey-program-sandbox/tools:api-feature
...
```shell
> NX Generating @pubkey-program-sandbox/tools:web-feature
